      ...
      <div className="w-50% max-w-md z-10">
        ...
        <div className="bg-slate-800/80 backdrop-blur-sm p-8 rounded-xl border border-slate-700 shadow-xl">
          ...
          <div className="space-y-3 mb-6">
            <button onClick={handleDiscordSignup} className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-3 rounded-lg transition-colors">
              {/* Discord SVG Icon */}
            ...
            <button onClick={handleGoogleSignup} className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-200 text-gray-800 font-bold py-3 rounded-lg transition-colors border border-slate-300">
              {/* Google SVG Icon */}
          ...
          <h1 className="text-xl font-bold text-white mb-6 text-center">Sign up with email</h1>
